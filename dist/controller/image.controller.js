...
router.put(url.update, verify_token_1.verifyToken, multer_1.upload.single("image"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.post(url.add, verify_token_1.verifyToken, multer_1.upload.fields([
    ...
    const result = yield imageService.create(request);
    res.json(new response_builder_1.ResponseBuilder(result)
        .withSuccess()
